...
[![Gemini](https://img.shields.io/badge/Gemini_AI-Flash_Lite-4285F4?style=for-the-badge&logo=google&logoColor=white)](https://ai.google.dev/)
...
[![CI](https://img.shields.io/badge/CI-GitHub_Actions-2088FF?style=for-the-badge&logo=github-actions&logoColor=white)](#-continuous-integration)
...
<img src="assets/hero-landing.png" alt="ToolWise Landing Page" width="800" />
...
<img src="assets/blueprint-dashboard.png" alt="Blueprint Dashboard" width="800" />
...
<img src="assets/tech-stack-cards.png" alt="Tech Stack Cards" width="800" />
...
<img src="assets/dataflow-architecture.png" alt="Data Flow and Architecture" width="800" />
...
<img src="assets/success-path-roadmap.png" alt="Success Path Roadmap" width="800" />
...
<img src="assets/risk-radar.png" alt="Risk Radar and Resume Tip" width="800" />
...
graph LR
    ...
    style A fill:#0f172a,stroke:#2dd4bf,color:#fff
    style B fill:#0f172a,stroke:#2dd4bf,color:#fff
    style C fill:#1e293b,stroke:#4285F4,color:#fff
    style D fill:#1e293b,stroke:#f59e0b,color:#fff
    style E fill:#0f172a,stroke:#2dd4bf,color:#fff
    style F fill:#0f172a,stroke:#2dd4bf,color:#fff
    style G fill:#0f172a,stroke:#2dd4bf,color:#fff
    style H fill:#1e293b,stroke:#3FCF8E,color:#fff
    style I fill:#0f172a,stroke:#2dd4bf,color:#fff
```
...
graph LR
    ...
    style A fill:#1e293b,stroke:#2dd4bf,color:#fff
    style B fill:#1e293b,stroke:#60a5fa,color:#fff
    style C fill:#1e293b,stroke:#34d399,color:#fff
    style D fill:#1e293b,stroke:#a78bfa,color:#fff
    style E fill:#1e293b,stroke:#f59e0b,color:#fff
    style F fill:#1e293b,stroke:#f43f5e,color:#fff
```
...
<img src="assets/hero-landing.png" alt="Landing Page" width="700" />
...
<img src="assets/blueprint-dashboard.png" alt="Blueprint Dashboard" width="700" />
...
<img src="assets/tech-stack-cards.png" alt="Tech Stack" width="700" />
...
<img src="assets/dataflow-architecture.png" alt="Architecture" width="700" />
...
<img src="assets/success-path-roadmap.png" alt="Success Path" width="700" />
...
<img src="assets/risk-radar.png" alt="Risk Radar" width="700" />
